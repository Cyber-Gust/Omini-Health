      ...
      <div className="absolute inset-0 flex items-center justify-end p-6 md:p-12">
        <div className="flex flex-col md:mr-32 items-end justify-center text-center max-w-xs">
          ...
          <Link
            ...
            className="mt-24 mr-4 md:mt-4 md:mr-9 inline-flex items-center justify-center rounded-md bg-white px-5 py-3 text-base font-semibold text-brand-dark shadow-lg hover:bg-gray-100 transition-transform hover:scale-105"
          >
